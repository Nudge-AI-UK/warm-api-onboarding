          ...
          <CardContent className="p-8">
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mb-8">
              <p className="text-sm text-foreground">
                {isFirstKey ? (
                  <><strong>2,000 free credits (£20)</strong> have been added to your account. Use them to test the IP Intelligence API.</>
                ) : (
                  <>Your new API key is ready to use. Credits are shared across all your keys.</>
                )}
              </p>
            </div>
